...
class TransformerKplugModel(TransformerMASSModel):
    ...
    def forward(self, src_tokens=None, src_lengths=None, prev_output_tokens=None, prev_output_positions=None,
        ...
        encoder_out = self.encoder(src_tokens, src_lengths=src_lengths, sku_vec_tokens=sku_vec_tokens,
                                   img_vec_tokens=img_vec_tokens, img_vec_tokens_len=img_vec_tokens_len)
