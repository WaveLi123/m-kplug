...
def main(args):
    ...
    if args.joined_dictionary:
        ...
        if args.srcdict:
            src_dict = task.load_dictionary(args.srcdict, args.bertdict)
        elif args.tgtdict:
            src_dict = task.load_dictionary(args.tgtdict, args.bertdict)
        else:
            assert (
                args.trainpref
        ...
        if target:
            if args.tgtdict:
                tgt_dict = task.load_dictionary(args.tgtdict, args.bertdict)
            else:
                assert (
                    args.trainpref
